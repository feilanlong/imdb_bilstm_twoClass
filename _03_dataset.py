...
from _02_build_vocab import build_vocab
build_vocab()
...
if __name__ == "__main__":
    ...
    imdb_dataset = ImdbDataset(train=True, sequence_max_len=100)
    # 不加collate_fn会报：RuntimeError: each element in list of batch should be of equal size  
